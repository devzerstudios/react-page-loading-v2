(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["reactLoaders"] = factory();
	else
		root["reactLoaders"] = factory();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_is__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_shallowequal__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__emotion_unitless__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__emotion_is_prop_valid__ = __webpack_require__(21);
...
var _BarLoader = __webpack_require__(16);

var _BarLoader2 = _interopRequireDefault(_BarLoader);

var _BubbleSpinLoader = __webpack_require__(24);

var _BubbleSpinLoader2 = _interopRequireDefault(_BubbleSpinLoader);

var _BubbleLoader = __webpack_require__(26);

var _BubbleLoader2 = _interopRequireDefault(_BubbleLoader);

var _CometSpinLoader = __webpack_require__(28);

var _CometSpinLoader2 = _interopRequireDefault(_CometSpinLoader);

var _ResizeSpinLoader = __webpack_require__(30);

var _ResizeSpinLoader2 = _interopRequireDefault(_ResizeSpinLoader);

var _RotateSpinLoader = __webpack_require__(32);

var _RotateSpinLoader2 = _interopRequireDefault(_RotateSpinLoader);

var _SpinLoader = __webpack_require__(34);
  ...
  if (loading) {
    if (loader == "bar") {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_BarLoader2.default, { color: color, duration: duration, size: size })
      );
    } else if (loader == "bubble-spin") {
      return _react2.default.createElement(
        "div",
        { style: containerStyle },
        _react2.default.createElement(_BubbleSpinLoader2.default, { color: color, duration: duration, size: size })
      );
    } else if (loader == "bubble") {
      return _react2.default.createElement(
        "div",
        { style: containerStyle },
        _react2.default.createElement(_BubbleLoader2.default, { color: color, duration: duration, size: size })
      );
    } else if (loader == "comet-spin") {
      return _react2.default.createElement(
        "div",
        { style: containerStyle },
        _react2.default.createElement(_CometSpinLoader2.default, { color: color, duration: duration, size: size })
      );
    } else if (loader == "cylinder-spin") {
      return _react2.default.createElement(
        "div",
        { style: containerStyle },
        _react2.default.createElement(CylinderSpin, { color: color, duration: duration, size: size })
      );
    } else if (loader == "resize-spin") {
      return _react2.default.createElement(
        "div",
        { style: containerStyle },
        _react2.default.createElement(_ResizeSpinLoader2.default, { color: color, duration: duration, size: size })
      );
    } else if (loader == "rotate-spin") {
      return _react2.default.createElement(
        "div",
        { style: containerStyle },
        _react2.default.createElement(_RotateSpinLoader2.default, { color: color, duration: duration, size: size })
      );
    } else if (loader == "spin") {
      return _react2.default.createElement(
        "div",
        { style: containerStyle },
        _react2.default.createElement(_SpinLoader2.default, { color: color, duration: duration, size: size })
      );
    }
  }
...
var _Bar = __webpack_require__(17);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__emotion_memoize__ = __webpack_require__(22);
...
var _BubbleSpin = __webpack_require__(25);
...
var _CometSpin = __webpack_require__(29);

var _CometSpin2 = _interopRequireDefault(_CometSpin);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var CometSpinLoader = function CometSpinLoader(props) {
  return _react2.default.createElement(_CometSpin2.default, props);
};
...
exports.default = CometSpinLoader;
...
var round = (0, _styledComponents.keyframes)(_templateObject2);

var CometSpin = _styledComponents2.default.div(_templateObject3, function (props) {
  return loading + ' ' + props.duration + 's infinite ease, ' + round + ' ' + props.duration + 's infinite ease';
}, function (props) {
  return props.color;
}, function (props) {
  return props.size + 'px';
...
var _ResizeSpin = __webpack_require__(31);

var _ResizeSpin2 = _interopRequireDefault(_ResizeSpin);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ResizeSpinLoader = function ResizeSpinLoader(props) {
  return _react2.default.createElement(_ResizeSpin2.default, props);
};
...
exports.default = ResizeSpinLoader;
...
var ResizeSpin = _styledComponents2.default.div(_templateObject2, function (props) {
  return props.color;
}, function (props) {
  return props.size + 'px';
}, function (props) {
  return loading + ' ' + props.duration + 's infinite ease 1.5s';
}, function (props) {
  return props.background;
}, function (props) {
  return loading + ' ' + props.duration + 's infinite ease';
}, function (props) {
  return props.background;
});

exports.default = ResizeSpin;
...
var _RotateSpin = __webpack_require__(33);
